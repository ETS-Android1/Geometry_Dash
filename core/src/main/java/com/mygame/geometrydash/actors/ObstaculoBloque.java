...
public class ObstaculoBloque extends Actor{

    private static final float OBS_WIDTH = 2.2f;
    private static final float OBS_HEIGHT = .55f;
    ...
    public ObstaculoBloque(World world, TextureRegion obstaculo, Vector2 position) {
